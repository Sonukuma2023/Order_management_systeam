                    ...
                    <div class="password-section">
                        ...
                        <div class="input-group mt-10">
                            <div class="password-wrapper">
                                ...
                                <!-- Clickable toggle container -->
                                <span class="eye-icon-toggle" @click="showPassword = !showPassword">
                                    
                                    <!-- ICON 1: 'Hide' / Eye-Off (when showPassword is true) -->
                                    <!-- This SVG is visually identical to image_0.png -->
                                    <svg v-if="showPassword" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-icon-svg eye-off-svg"><path d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19M3 3l18 18"></path></svg>
                                    
                                    <!-- ICON 2: 'Show' / Eye-On (when showPassword is false) -->
                                    <!-- A matching line-art open-eye -->
                                    <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="eye-icon-svg eye-on-svg"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg>
...
/* Container to hold the input and the icon */
.password-wrapper {
    position: relative;
    display: flex;
    align-items: center;
...
/* Ensure the input takes full width but leaves space on the right for the icon */
.password-wrapper input {
    width: 100%;
    padding-right: 40px; /* Prevents text from hiding behind the eye icon */
}

/* Position and style the clickable toggle container */
.eye-icon-toggle {
    position: absolute;
    right: 12px;      /* Distance from the right edge */
    cursor: pointer;  /* Shows a pointer finger on hover */
    user-select: none; /* Prevents text selection */
    display: flex;
    align-items: center;
    justify-content: center;
    width: 22px;       /* Fix size of the icon area */
    height: 22px;
}

/* Styling for the SVG icons themselves */
.eye-icon-svg {
    width: 100%;       /* Take full size of the .eye-icon-toggle container */
    height: 100%;
    color: #6b7280;   /* A neutral gray color (applies to stroke) */
